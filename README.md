...
- [2. 起動とネットワーク接続](#2-起動とネットワーク接続)
	...
	- [2.2. ゲートウェイのIPアドレス探索](#22-ゲートウェイのipアドレス探索)
		- [2.2.1. 探索手順](#221-探索手順)
- [3. ゲートウェイ コントローラー](#3-ゲートウェイ-コントローラー)
	- [3.1. 基本操作](#31-基本操作)
		- [3.1.1. ログイン](#311-ログイン)
...
E-Kit EnOcean Gateway では次の各種サービスへの接続機能をサポートしています。これらの機能は今後、拡充、更新される場合があります。
...
ログインに成功すると、次の様なメイン操作画面の「コントロールページ」が表示されます。E-Kit EnOcean Gatewayの基本操作は、このページで行います。次のコントロールページの各項目の役割を説明します。
...
<div style="text-align: center;">
<img src="img/C2.png" alt="登録済デバイス表示" width="65%"/><br/>
